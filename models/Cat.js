class Cat {
    ...
    static async createCat(insertValues) {
        /* const { rows } = await this._client.query(`INSERT INTO ${this._tableName} (name, breed, color, birthday, weight) VALUES 
        ('${name}', '${breed}', '${color}', '${birthday}', ${weight}) RETURNING *;`);
        return rows; */
        ...
        const str = `INSERT INTO ${this._tableName} (${insertAttrSchema}) VALUES (${insertValueString}) RETURNING *;`;
